                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                          ...
                                                          border-radius: 14px;"
                                                                ...
                                                                <option value="{{ route('s.materials', $id) }}">Material Performance</option>
                                                                <option value="{{ route('s.activity', $id) }}">Activity Performance</option>
                                                                <option value="{{ route('s.attend', $id) }}">Attendance </option>
                                                                <option value="{{ route('s.behavior', $id) }}">Behavior </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
