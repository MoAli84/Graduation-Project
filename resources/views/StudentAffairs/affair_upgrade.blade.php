        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                @endif --}}
                                    ...
                                    <h4 class="card-title">upgrade Data</h4>
                                    <!-- <p class="card-description">
                      Basic form layout
                    </p> -->


                                    <form class="forms-sample" action="{{ 'affair/store2' }}" method="POST">
                                        {{-- @method('PUT') --}}
                                        @csrf
{{--  --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="Name" disabled
                                                value="{{ $data->Name ." ". $data->FatherName }}" id="exampleInputfssn" placeholder="student name"
                                                style="width: 50%;" >
                                        </div>
                                        {{-- <div class="form-group">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <select class="form-control" name="LevelId" id="exampleSelectGender" disabled>
                                                @foreach ($sub as $info)
                                                <option value="{{ $info->id }}"  @if ($sub->LevelId == $info->Id) selected @endif>
                                                    {{ $info->SubLevelName }}
                                                </option >
                                            @endforeach
                                            </select>
