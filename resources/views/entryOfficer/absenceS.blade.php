                        ...
                        <div class="row">
                            <div class="card-body">
                                ...
                                <div class="b4" id="box3" style="margin-top: 0px;">
                                    ...
                                    <form action="{{ route('e.storeS', $id) }}" method="POST">
                                        @csrf

                                        <div><input type="date" id="date"
                                                style="padding: 4px 19px; margin-bottom:10px; margin-right:10px;"
                                                name="datee"></div>

                                        <button class="btn btn-md btn-warning" id="addBtna" type="button"
                                            style="padding: 4px 19px; margin-bottom:10px; margin-right:10px; float:right; font-size: 20px; ">+</button>
