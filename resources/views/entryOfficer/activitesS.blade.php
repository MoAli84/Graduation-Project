                                    ...
                                    <table class="table table-bordered" style="width:100%; height: 60px;">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <form action="{{ route('e.scoresS', $id) }}" method="POST">
                                                    @csrf

                                                    @foreach ($d4 as $dd4)
                                                        <td class="header-label">
                                                            <div><input type="text" value="{{ $dd4['ActivityName'] }}"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($d2 as $dd2)
                                                <tr class="tr-inputs">
                                                    <td scope="row">
                                                        <div><input type="text" value="{{ $dd2['id'] }}" readonly
                                                                name="stuid[]"></div>
                                                    </td>
                                                    <td class="col-md-4">
                                                        <div><input type="text" value="{{ $dd2['Name'] }}" readonly
                                                                name="stuname[]"></div>
                                                    </td>
