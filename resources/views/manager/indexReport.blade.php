                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    ...
                                    <form action="{{ route('m.search', $id) }}" method="get">
                                        @csrf

                                        <div class="card-body">
                                            <div class="input-group mb-4" style="width:40% ; ">
                                                <input type="text" class="form-control input-text"
                                                    placeholder="Search student...." aria-label="Recipient's username"
                                                    aria-describedby="basic-addon2" name="studentid">
                                   ...
                                   {{--  <form action="{{ route('m.indexReport', $id) }}" method="get">
                                        @csrf
                                        @if (isset($_GET['studentid']))
                                            <input href="{{ route('m.indexReport', $id) }}" class="btn btn-warning"
                                                value="back" type="submit" style="margin-left: -350px" >
                                        @endif
                                    </form>
 --}}
                                    <div class="b1" id="box" style="margin-top: 5%;">
                                        <table class="table table-bordered" style="width:100%; height: 60px;">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($d1 as $dd1)
                                                    <tr>
                                                        <th scope="row">{{ $dd1['id'] }}</th>
                                                        <td class="col-md-4">{{ $dd1['Name'] }}</td>

                                                        <td>
                                                            <a href="{{ route('m.SR1', $dd1['id']) }}"
                                                                type="button" class="btn btn-primary">
                                                                First Term</a>
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('m.SR2', $dd1['id']) }}"type="button"
                                                                class="btn btn-info">
                                                                Second Term</a>
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('m.AYR', $dd1['id']) }}"
                                                        ...
                                                        @if ($id == 6 || $id == 9 || $id == 12)
                                                            <td>
                                                                <a href="{{ route('m.ESR', $dd1['id']) }}"type="button"
                                                        ...
                                                        <td>
                                                            <a href="{{ route('m.history', $dd1['id']) }}"type="button"
